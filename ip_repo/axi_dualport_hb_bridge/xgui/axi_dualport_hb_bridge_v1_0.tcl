...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_BURST_BEATS" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_BURST_BEATS { PARAM_VALUE.MAX_BURST_BEATS } {
	# Procedure called to update MAX_BURST_BEATS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_BURST_BEATS { PARAM_VALUE.MAX_BURST_BEATS } {
	# Procedure called to validate MAX_BURST_BEATS
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_BURST_BEATS { MODELPARAM_VALUE.MAX_BURST_BEATS PARAM_VALUE.MAX_BURST_BEATS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_BURST_BEATS}] ${MODELPARAM_VALUE.MAX_BURST_BEATS}
}
